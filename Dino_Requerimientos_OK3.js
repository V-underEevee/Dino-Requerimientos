...
// ============================================
// CLASE TRIVIA - CON TEXTO AJUSTABLE PERFECTAMENTE
// ============================================
class TriviaModal {
    ...
    dibujar() {
        ...
        // Guardar posiciones para detección de clicks
        this.posicionesOpciones = [];
...
function procesarRespuestaTrivia() {
    ...
    if (resultado === 'correcto') {
        ...
        // TEMBLOR Y EXPLOSIÓN EN EL ERROR
        juego.errorShake = 12;
        reproducirError();
        juego.juegoPausado = true;
        colisionPendiente = true;
        
        const impactoX = obstaculo ? obstaculo.x + obstaculo.ancho / 2 : dino.x + dino.ancho / 2;
        const impactoY = obstaculo ? obstaculo.y + obstaculo.alto / 2 : dino.y + dino.alto / 2;
        mostrarExplosion(impactoX, impactoY);
